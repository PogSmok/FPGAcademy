...
# if simulating with a MIF file, copy it to the working folder.
set source_mif "inst_mem.mif"
# set source_mif "sitbooboosit.mif"
if {[file exists ../$source_mif]} {
	file delete inst_mem.mif
	file copy ../$source_mif inst_mem.mif
}
