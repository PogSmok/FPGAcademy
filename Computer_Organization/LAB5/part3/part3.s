...
key_0:
            ...
            j       irq_ret
key_1:
            la      t0, MTIMECMP_BASE   # HI word
            lw      t1, 4(t0)
            srli    t2, t1, 1
            sw      t2, 4(t0)           # store changed HI word
            slli    t1, t1, 31
	    lw      t2, (t0)            # LO word
            srli    t2, t2, 1           
            or      t2, t2, t1          # include shifted LSB from HI word
            sw      t2, (t0)            # store chagned LO word
            j       irq_ret
key_2:
            la      t0, MTIMECMP_BASE   # LO word
            lw      t1, (t0)
            slli    t2, t1, 1
            sw      t2, (t0)            # store changed LO word
            srli    t1, t1, 31
	    lw      t2, 4(t0)           # HI word
            slli    t2, t2, 1           
            or      t2, t2, t1          # include shifted MSB from LO word
            sw      t2, 4(t0)           # store chagned HI word
            j       irq_ret
